...
class date
{
    ...
    public:
    date(){}
    friend void operator>>(istream &in, date &d); //Overloading >> operator ///Iako funkcijata friend e definirana nadvor od klasata taa moze da pristapuva do site privatni i zastitni clenovi na klasata. ////
    friend void operator<<(ostream &out, date &d) //Overloading << operator //// Overloading operatorot ni dava moznost da ja smenime funkcijata na operatorite za da izvrsuvaat druga zadaca . ////
...
// https://www.programiz.com/cpp-programming/operator-overloading
{
    ...
    in>>d.month;
    cout<<"\n Enter Year : ";
    in>>d.year; // smeni in, shto se dobiva ? //// Ke go dobieme istiot rezultat zatoa sto so overloading operatorot ja smenivme funkcijata na operatorot " >> " da se vnesuva od input od korisnikot preku koristenje na " in ". ////
    cout<<"\n Enter Hour : ";
    in>>d.hour;
