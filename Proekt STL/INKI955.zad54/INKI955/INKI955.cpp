...
int main()
{
    ...
    vremenska_prognoza.push_back({ "Bitola", 21, 11 });
    vremenska_prognoza.push_back({ "Tetovo", 20, 10 });
    vremenska_prognoza.push_back({ "Kumanovo", 19, 9 });
    vremenska_prognoza.push_back({ "Veles", 23, 13 });
    vremenska_prognoza.push_back({ "Gostivar", 18, 8 });
    vremenska_prognoza.push_back({ "Strumica", 25, 15 });
    ...
    string file = "INKI955.VremenskaPrognoza" + to_string(datum->tm_mon + 1) + to_string(datum->tm_mday) + ".txt";
